...
def attack(char_name: str, char_class: str) -> str:
    """Determine the amount of damage dealt. When attacked."""
...
def defence(char_name: str, char_class: str) -> str:
    """Determine the amount of damage dealt. When protected."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Determine the amount of damage dealt. With a special skill."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Select a character class, a function will be called.
    Depending on the character's choice of action:
...
def choice_char_class() -> str:
    """Choose class. There is a search of the proposed values."""
    approve_choice: str = ''
    char_class: str = ''
